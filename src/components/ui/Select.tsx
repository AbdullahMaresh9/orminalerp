            ...
            return (
              <li key={option.value} role="option" aria-selected={isSelected}>
                <button
                  ...
                  className={`flex w-full items-center justify-between gap-2 rounded-lg px-3 py-2.5 text-start text-sm transition ${
                    isActive ? 'bg-brand-50 text-brand-700 dark:bg-white/5 dark:text-brand-200' : ''
                  }`}
                >
